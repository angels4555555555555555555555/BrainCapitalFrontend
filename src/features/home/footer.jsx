  ...
  return (
    <footer className="site-footer" id="footer">
      ...
      <div className="site-container footer-legal">
        <p>
          Brain Capital Asset GmbH vermittelt und begleitet Finanzstrategien im Bereich Vermögensverwaltung, Kapitalmarkt & IPO sowie Fest- und Tagesgeld. Die Inhalte dieser Website dienen ausschließlich der allgemeinen Information und stellen keine individuelle Anlageberatung dar. Kapitalanlagen sind grundsätzlich mit Risiken verbunden, unter anderem dem Risiko des teilweisen oder vollständigen Verlusts des eingesetzten Kapitals.
        </p>
        <p>
      ...
      <div className="site-container footer-bottom">
        <span>© {new Date().getFullYear()} Brain Capital Asset GmbH</span>
